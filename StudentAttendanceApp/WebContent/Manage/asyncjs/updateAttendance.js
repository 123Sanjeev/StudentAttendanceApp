...
function searchUpdateAttendance(x){
	...
	var id = "searchUapp"
	x.open("GET", "http://192.168.0.173:8080/StudentAttendanceApp/updateStudent?appid="+id + "&class="+uEle[0].value+"&atndDate="+uEle[1].value+"&section="+uEle[2].value,true);
	x.onload = ()=>{
...
function loadupdateapp(val){
	var appid="oprcrd";
	xhr.open("GET","http://192.168.0.173:8080/StudentAttendanceApp/Manage/manageAttendance/openMRecord.jsp?val="+val,true);
	xhr.onload = ()=>{
